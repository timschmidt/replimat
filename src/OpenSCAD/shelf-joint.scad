...
// frames
translateFrame([0,10,4]) xFrame(holes);
translateFrame([0,1,4]) xFrame(holes);
translateFrame([1,1,3]) yFrame(holes);
...
// bolts
translateFrame([9,0,4]) rotate([90,0,0]) replimat_nut_and_bolt(2);
translateFrame([1,1,5]) rotate([0,0,0]) replimat_nut_and_bolt(2);
translateFrame([0,1,4]) rotate([90,0,0]) replimat_nut_and_bolt(2);
translateFrame([9,12,5]) rotate([-90,0,0]) replimat_nut_and_bolt(2);
translateFrame([1,10,5]) rotate([0,0,0]) replimat_nut_and_bolt(2);
translateFrame([0,11,5]) rotate([-90,0,0]) replimat_nut_and_bolt(2);
