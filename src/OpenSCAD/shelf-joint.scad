...
// bolts
translateFrame([9,0,1]) rotate([90,0,0]) replimat_nut_and_bolt(2);
translateFrame([1,1,2]) rotate([0,0,0]) replimat_nut_and_bolt(2);
translateFrame([0,1,1]) rotate([90,0,0]) replimat_nut_and_bolt(2);
translateFrame([9,12,2]) rotate([-90,0,0]) replimat_nut_and_bolt(2);
translateFrame([1,10,2]) rotate([0,0,0]) replimat_nut_and_bolt(2);
translateFrame([0,11,2]) rotate([-90,0,0]) replimat_nut_and_bolt(2);
