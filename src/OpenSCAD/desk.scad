...
translateFrame([1,5,2]) replimat_plate(10, 10);
translateFrame([11,5,2]) replimat_plate(10, 10);
translateFrame([21,5,2]) replimat_plate(10, 10);
...
translateFrame([1,5,11]) replimat_plate(10, 10);
translateFrame([11,5,11]) replimat_plate(10, 10);
translateFrame([21,5,11]) replimat_plate(10, 10);
...
translateFrame([1,0,21]) replimat_plate(10, 10);
translateFrame([11,0,21]) replimat_plate(10, 10);
translateFrame([21,0,21]) replimat_plate(10, 10);
translateFrame([1,10,21]) replimat_plate(10, 5);
translateFrame([11,10,21]) replimat_plate(10, 5);
translateFrame([21,10,21]) replimat_plate(10, 5);
...
translateFrame([16,5,30]) replimat_plate(5,10);
translateFrame([21,5,30]) replimat_plate(10,10);


// Top shelf
translateFrame([1,6,37]) yFrame(10);
translateFrame([30,6,37]) yFrame(10);
translateFrame([1,5,39]) replimat_plate(10, 10);
translateFrame([11,5,39]) replimat_plate(10, 10);
translateFrame([21,5,39]) replimat_plate(10, 10);
