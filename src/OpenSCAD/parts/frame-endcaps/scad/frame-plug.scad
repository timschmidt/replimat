...
// to do:
//   [x]add replimat logo
//   [x]add plastic recycling logo
//   [ ]add positive retainment with two-way (45 deg U shaped?) bolt loop
...
// For display only, doesn't conbute to final object
...
// The cap/plug is built here... 
  ...
  mirror()
  import("../../../../../bin/stl/logo-replimat.stl");
  
  translate([2,2,1.7])
  rotate([0,0,-45])
  //mirror()
  Recycling_Symbol(Symbol = 1,Numerical_Code = "7", Plastic_Symbol = "PETG", Length = 18, Width = 18, Thickness = 0.6, Arrow_Width = 1, Arrow_Head_Width = 3, Arrow_Head_Length = 2);
