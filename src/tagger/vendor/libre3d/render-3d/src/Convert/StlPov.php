...
class StlPov extends Convert {
	...
	public function convert() {
		...
		$tplVars['real_x'] = $diff['x'];
		$tplVars['real_y'] = $diff['y'];
		$tplVars['real_z'] = $diff['z'];
		$tplVars['x'] = max(array($diff['x'], $diff['y'], $diff['z']));
		$tplVars['y'] = max(array($diff['x'], $diff['y'], $diff['z']));
		$tplVars['z'] = max(array($diff['x'], $diff['y'], $diff['z']));
